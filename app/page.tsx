...
export default function Home() {
  return <main>
    ...
    <footer style={{position:"relative", isolation:"isolate", overflow:"hidden"}}>
      <div className="footer-sticker-border" aria-hidden="true" style={{position:"absolute", insetBlock:0, left:0, width:"clamp(96px, 10vw, 150px)", overflow:"hidden", pointerEvents:"none", zIndex:0}}><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" style={{position:"absolute", left:"50%", top:"50%", width:"520px", height:"auto", maxWidth:"none", transform:"translate(-50%, -50%) rotate(90deg)", transformOrigin:"center"}} /></div>
      <div className="footer-sticker-border" aria-hidden="true" style={{position:"absolute", insetBlock:0, right:0, width:"clamp(96px, 10vw, 150px)", overflow:"hidden", pointerEvents:"none", zIndex:0}}><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" style={{position:"absolute", left:"50%", top:"50%", width:"520px", height:"auto", maxWidth:"none", transform:"translate(-50%, -50%) rotate(-90deg)", transformOrigin:"center"}} /></div>
