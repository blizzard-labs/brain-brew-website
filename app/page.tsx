...
export default function Home() {
  return <main>
    ...
    <footer>
      <div className="footer-sticker-side footer-sticker-side-left" aria-hidden="true"><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" /></div>
      <div className="footer-sticker-side footer-sticker-side-right" aria-hidden="true"><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" /></div>
