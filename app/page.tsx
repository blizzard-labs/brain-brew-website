...
export default function Home() {
  return <main>
    ...
    <footer style={{position:"relative", isolation:"isolate", overflow:"hidden"}}>
      <div className="footer-sticker-border" aria-hidden="true" style={{position:"absolute", insetBlock:0, left:"calc(var(--footer-sticker-canvas, 410px) * -.25)", width:"var(--footer-sticker-canvas, 410px)", pointerEvents:"none", zIndex:0}}><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" style={{position:"absolute", left:"50%", top:"50%", width:"var(--footer-sticker-length, 1230px)", height:"auto", maxWidth:"none", transform:"translate(-50%, -50%) rotate(90deg)", transformOrigin:"center"}} /></div>
      <div className="footer-sticker-border" aria-hidden="true" style={{position:"absolute", insetBlock:0, right:"calc(var(--footer-sticker-canvas, 410px) * -.25)", width:"var(--footer-sticker-canvas, 410px)", pointerEvents:"none", zIndex:0}}><Image src="/brain-brew-sticker-strip-v3.png" width={2172} height={724} alt="" style={{position:"absolute", left:"50%", top:"50%", width:"var(--footer-sticker-length, 1230px)", height:"auto", maxWidth:"none", transform:"translate(-50%, -50%) rotate(-90deg)", transformOrigin:"center"}} /></div>
      <div className="shell footer-grid" style={{position:"relative", zIndex:1}}><div><div className="brand light"><span className="brain-mark">BB</span><span>Brain Brew<span>Ride SF</span></span></div><h2>Ride, Run,<br/>Remember.</h2></div><div><p className="eyebrow">Questions?</p><a href="mailto:brainbrewsf@googlegroups.com"><Mail size={17}/>brainbrewsf@googlegroups.com</a><a href="tel:+16692919198">Day-of: (669) 291-9198</a><Button asChild className="footer-button"><a href="https://forms.gle/TBYodKPwEr8REew2A" target="_blank" rel="noreferrer">Register for free <ArrowRight size={16}/></a></Button></div></div><div className="shell footer-bottom" style={{position:"relative", zIndex:1}}><span>Brain Brew Ride · September 19–21, 2026</span><span>San Francisco, California</span></div>
    </footer>
