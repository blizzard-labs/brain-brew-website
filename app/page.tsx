...
const days = [
  ...
  { n: "03", day: "three" as const, date: "SAT · OCT 24", title: "Corpus Callosum Run", location: "Kimbell Park", time: "8:00–10:00 AM", icon: PersonStanding, text: "A welcoming 5K community run/walk with Walk to End Alzheimer’s SF. All paces, walkers, strollers, and leashed dogs are welcome.", tone: "coral" },
];
...
export default function Home() {
  return <main>
    ...
    <section className="hero-section" id="top"><div className="hero shell">
      <div className="hero-copy"><p className="eyebrow">October 17, 18 & 24, 2026 · San Francisco</p><h1>Every <em>mind</em><br/>has a <em>story.</em></h1>
        <p className="lede">Three youth-led days of movement, learning, and connection—building empathy for people living with Alzheimer’s and Parkinson’s, and supporting their families.</p>
