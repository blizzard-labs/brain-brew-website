...
export default function Home() {
  return <main>
    <header className="site-header">
      ...
      <nav className="nav shell" aria-label="Main navigation">
        ...
        <div className="nav-actions">
          ...
          <DonationDialog size="default" className="header-donate"/>
        </div>
      </nav>
    </header>
    ...
    <section className="details section" id="plan"><div className="shell">
      ...
      <article className="event-block" id="day-two"><div className="event-num">DAY 02</div><div><p className="eyebrow teal-text">Sunday · Drop in anytime</p><h2>A community day for curious minds</h2><p className="event-intro">For the entire family! Stay for twenty minutes or the afternoon- anytime from 11AM to 3PM.</p><div className="station-grid"><div><span>01</span><h3>The Empathy Café</h3><p>Try tremor gloves and vision-distorting goggles while seated with a spotter.</p></div><div><span>02</span><h3>The Memory Wall</h3><p>Honor someone you love who has been affected.</p></div><div><span>03</span><h3>Build-a-Brain</h3><p>Kids create a model and learn what each region does.</p></div><div><span>04</span><h3>Move Your Mind</h3><p>Light games connect movement with long-term brain health.</p></div></div></div></article>
